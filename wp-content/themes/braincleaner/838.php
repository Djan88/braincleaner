    ...
    <div class="row">
        <div class="col-xs-12 vspread_wrap">
          <div class="vspread">
            ...
            <img src="<?php bloginfo('template_url'); ?>/img/v-spread.png" alt="arrow_s" class="vspread_zone_arrow vspread_zone_arrow_s vspread_zone_0">
            <img src="<?php bloginfo('template_url'); ?>/img/v-spread_l.png" alt="arrow_l" class="vspread_zone_arrow vspread_zone_arrow_l">
