<?php if(is_category(5)) { ?><h4 style="padding-bottom: 6px;padding-top: 25px;">Обучение методике +7(495) 255-05-61 <a href="mailto:yuchikurov@gmail.com">yuchikurov@gmail.com</a></h4><?php } ?>
