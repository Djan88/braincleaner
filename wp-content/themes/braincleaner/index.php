  ...
  <?php } else { ?>
    <div class="container-fluid inside animsition <?php if(is_page(617)){?>class_617<?php } ?>">
          ...
          <?php } else { ?>
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
              <?php if(is_single() || is_page()) { ?>
                <h3><?php the_title(); ?> <?php if(is_category(5)) { ?> Обучение методике +7(495) 255-05-61 <a href="mailto:yuchikurov@gmail.com">yuchikurov@gmail.com</a><?php } ?></h3>
              <?php } else { ?>
      ...
      <div class="row footer-wrap">
        <div class="container">
          <div class="pull-left">
            <a href="/">Braincleaner</a> 2015 v 1.2
          </div>
